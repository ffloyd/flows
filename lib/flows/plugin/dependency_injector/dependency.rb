module Flows
  module Plugin
    module DependencyInjector
      ...
      #
      # @api private
      Dependency = Struct.new(:name, :definition, :provided_value, :value, keyword_init: true) do
        def initialize(*)
          super
          ...
          raise UnexpectedDependencyTypeError if type != NO_TYPE && !(type === value) # rubocop:disable Style/CaseEquality
        end
